...
export const metadata: Metadata = {
  ...
  description:
    'Услуги по асфальтированию в Москве и области: асфальт от 1000 ₽/м² (до 5 см), с материалом около 1700 ₽/м²; ШМА от 300 ₽/м²; брусчатка под ключ около 3500 ₽/м²; бордюры от 700–1200 ₽/пм.',
